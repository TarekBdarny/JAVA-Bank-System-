...
public class DepositWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("How much money you want to deposit?");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(105, 105, 105)
                        .addComponent(DepositInput, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(79, 79, 79)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double amount = 0;
        try{
            amount = Double.parseDouble(DepositInput.getText());
        }
        catch(Exception e)
        {
        ...
        if(amount > 5000)
        {
            ...
            if(helper.depositMoney(amount, win.userCardNumber, win.cardPinCode))
                JOptionPane.showMessageDialog(this,
                    "Deposit succsess",
                    "Deposit succsess", JOptionPane.INFORMATION_MESSAGE);
            mw.addMoneyToBalance(amount);
